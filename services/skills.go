...
var skillDefs = []skillDef{
	...
	},
	{
		...
		Summary:  "1/3 池需 20% 胜率、1/2 池 25%、1 倍池 33%、2 倍池 40%；转牌面对 1/2 池以上的下注，9 张 outs 及以下的听牌跟注都是错的",
		Priority: 95,
		Trigger:  SkillTrigger{Always: true},
...
// 正文那边常驻两篇（core-stance 1280 + odds-table 2265，实测 2026-09-24）自己就占
// 3545 字，**展开第 1 篇非常驻技能就超顶**，等于每次分析都响；目录那边只在简单手牌
// （展开 ≤4 篇，★ 行少所以目录长）上响。**一条常态触发的告警等于没有告警。**
// （odds-table 在 2026-09-24 由 2000 → 2265 字，是三处口径订正带来的，见
// `赔率训练设计文档.md` §2.4/§2.5/§2.7。数字会继续变，别把它当成承诺。）
//
